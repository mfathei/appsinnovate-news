        ...
        <div class="col-md-12 ">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <h1  class="page-heading center" align="center">Edit News</h1>
                    <div style="width: 100%;
                         margin-bottom: 50px;">
                    ...
                    <form id='edit-form' method="post" action="/news/edit/{{ $news->id }}" data-validate="parsley">
                        {{ csrf_field() }}
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title" required="" data-parsley-trigger="keyup" 
                                   ...
                                   data-parsley-minlength-message="Come on! You need to enter at least a 5 characters title.." value="{{ $news->title }}"/>
                        </div>
                        <div class="form-group">
